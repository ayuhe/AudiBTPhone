...
public class SupportFragment extends Fragment implements ISupportFragment{
				...
				// fragment所在界面布局的位置，只有当fragment在Right的位置时，才处理返回按键处理
				...
				/**
					* 是否允许Actiivty返回
					*
					* @return false不允许，true则Activity可以finish掉
					*/
				public boolean onActivityBackPressed(){
								return false;
				}

				public LayoutGravity getLayoutGravity(){
				...
				public void startForResult(SupportFragment toFragment, int requestCode){
								mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, requestCode, STANDARD, Fragmentation.TYPE_ADD_RESULT, null,
																null);
				}
